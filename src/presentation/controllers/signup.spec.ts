...
import { AddAccount, AddAccountModel } from '../../domain/uses-cases/add-account'
...
describe('SignUp Controller', () => {
  ...
  test('Should return 400 if password and passwordConfirmation fails', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should return 500 if EmailValidator throw With SPY', () => {
    const { sut, emailValidatorStub } = makeSut()
